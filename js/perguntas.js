export const perguntas = [
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Pois futebol é  o esporte coletivo mais popular do planeta."
                ],
                proxima: 1,
            },
            {
                ...
                afirmacao: [
                    "cerca de 270 milhões de pessoas atuam em atividades diretamente relacionados ao esporte."
                ],
                proxima: 2,
            },
        ]
    },
    {
        ...
        alternativas: [
            ...
            },
            {
                texto: "Volei.",
                afirmacao: [
                    "Infelizmente não é esse o esporte."
                ],
                proxima: 4,
            },
        ]
    ...
    {
        enunciado: "Qual é o país com mais copas do mundo?",
        alternativas: [
            {
                texto: "Brasil.",
                afirmacao: [
                    "Com sua ultima conquistada em 2002."
                ],
                proxima: 5,
            },
            {
